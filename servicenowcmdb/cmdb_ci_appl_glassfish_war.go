...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_glassfish_war CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_glassfish_war keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_glassfish_war CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_glassfish_war  = "cmdb_ci_appl_glassfish_war"
...
// This is essentially the same as CmdbCiApplGlassfishWarGet but does not contain the "value", "link" and
...
//
type CmdbCiApplGlassfishWarPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplGlassfishWarGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiApplGlassfishWar() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplGlassfishWar,
Read:   readResourceCmdbCiApplGlassfishWar,
Update: updateResourceCmdbCiApplGlassfishWar,
Delete: deleteResourceCmdbCiApplGlassfishWar,
...
//
func createResourceCmdbCiApplGlassfishWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplGlassfishWarPost
if err := copyFromTerraformToServiceNowCmdbCiApplGlassfishWar(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_glassfish_war + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplGlassfishWar(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplGlassfishWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_glassfish_war + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplGlassfishWar(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplGlassfishWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplGlassfishWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplGlassfishWarfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplGlassfishWar (resourceData *schema.ResourceData, ci *CmdbCiApplGlassfishWarPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplGlassfishWar (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplGlassfishWarGet{}
