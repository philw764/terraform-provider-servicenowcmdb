...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_oracle_golden_gate CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_oracle_golden_gate keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_oracle_golden_gate CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_oracle_golden_gate  = "cmdb_ci_appl_oracle_golden_gate"
...
// This is essentially the same as CmdbCiApplOracleGoldenGateGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOracleGoldenGatePost struct {
Result struct {
Attributes   struct {
            ...
            CountExtract    string `json:"count_extract,omitempty"`
            ...
            CountReplicat    string `json:"count_replicat,omitempty"`
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOracleGoldenGateGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOracleGoldenGate() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOracleGoldenGate,
Read:   readResourceCmdbCiApplOracleGoldenGate,
Update: updateResourceCmdbCiApplOracleGoldenGate,
Delete: deleteResourceCmdbCiApplOracleGoldenGate,
...
//
func createResourceCmdbCiApplOracleGoldenGate(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOracleGoldenGatePost
if err := copyFromTerraformToServiceNowCmdbCiApplOracleGoldenGate(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_oracle_golden_gate + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOracleGoldenGate(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOracleGoldenGate(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_oracle_golden_gate + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOracleGoldenGate(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOracleGoldenGate(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOracleGoldenGate(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOracleGoldenGatefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOracleGoldenGate (resourceData *schema.ResourceData, ci *CmdbCiApplOracleGoldenGatePost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.Type  = resourceData.Get("type").(string)
                ...
                attrs.CountExtract  = resourceData.Get("count_extract").(string)
                ...
                attrs.ReportFile  = resourceData.Get("report_file").(string)
                attrs.Cost  = resourceData.Get("cost").(string)
                attrs.Comments  = resourceData.Get("comments").(string)
                attrs.SourceDb  = resourceData.Get("source_db").(string)
                ...
                attrs.CountReplicat  = resourceData.Get("count_replicat").(string)
return nil
}
...
//
func copyFromServiceNowToTerraformCmdbCiApplOracleGoldenGate (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOracleGoldenGateGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("type", attrs.Type)
                ...
                _ = resourceData.Set("count_extract", attrs.CountExtract)
                ...
                _ = resourceData.Set("report_file", attrs.ReportFile)
                _ = resourceData.Set("cost", attrs.Cost)
                _ = resourceData.Set("comments", attrs.Comments)
                _ = resourceData.Set("source_db", attrs.SourceDb)
                ...
                _ = resourceData.Set("count_replicat", attrs.CountReplicat)
return nil
}
