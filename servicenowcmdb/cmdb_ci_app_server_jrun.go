...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_jrun CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_jrun keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_jrun CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_jrun  = "cmdb_ci_app_server_jrun"
...
// This is essentially the same as CmdbCiAppServerJrunGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerJrunPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerJrunGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerJrun() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerJrun,
Read:   readResourceCmdbCiAppServerJrun,
Update: updateResourceCmdbCiAppServerJrun,
Delete: deleteResourceCmdbCiAppServerJrun,
...
//
func createResourceCmdbCiAppServerJrun(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerJrunPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerJrun(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_jrun + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerJrun(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerJrun(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_jrun + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerJrun(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerJrun(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerJrun(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerJrunfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerJrun (resourceData *schema.ResourceData, ci *CmdbCiAppServerJrunPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.Application  = resourceData.Get("application").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerJrun (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerJrunGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("application", attrs.Application)
