...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ca CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ca keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ca CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ca  = "cmdb_ci_appl_ca"
...
// This is essentially the same as CmdbCiApplCaGet but does not contain the "value", "link" and
...
func ResourceCmdbCiApplCa() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplCa,
Read:   readResourceCmdbCiApplCa,
Update: updateResourceCmdbCiApplCa,
Delete: deleteResourceCmdbCiApplCa,
...
//
func createResourceCmdbCiApplCa(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplCaPost
if err := copyFromTerraformToServiceNowCmdbCiApplCa(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ca + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplCa(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplCa(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ca + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplCa(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplCa(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplCa(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplCafailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplCa (resourceData *schema.ResourceData, ci *CmdbCiApplCaPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplCa (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplCaGet{}
