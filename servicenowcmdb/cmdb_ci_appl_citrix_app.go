...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_citrix_app CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_citrix_app keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_citrix_app CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_citrix_app  = "cmdb_ci_appl_citrix_app"
...
// This is essentially the same as CmdbCiApplCitrixAppGet but does not contain the "value", "link" and
...
//
type CmdbCiApplCitrixAppPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplCitrixAppGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplCitrixApp() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplCitrixApp,
Read:   readResourceCmdbCiApplCitrixApp,
Update: updateResourceCmdbCiApplCitrixApp,
Delete: deleteResourceCmdbCiApplCitrixApp,
...
//
func createResourceCmdbCiApplCitrixApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplCitrixAppPost
if err := copyFromTerraformToServiceNowCmdbCiApplCitrixApp(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_citrix_app + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplCitrixApp(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplCitrixApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_citrix_app + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplCitrixApp(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplCitrixApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplCitrixApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplCitrixAppfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplCitrixApp (resourceData *schema.ResourceData, ci *CmdbCiApplCitrixAppPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.AppArgs  = resourceData.Get("app_args").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplCitrixApp (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplCitrixAppGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("app_args", attrs.AppArgs)
