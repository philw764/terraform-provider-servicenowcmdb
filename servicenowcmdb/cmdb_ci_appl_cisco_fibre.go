...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_cisco_fibre CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_cisco_fibre keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_cisco_fibre CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_cisco_fibre  = "cmdb_ci_appl_cisco_fibre"
...
// This is essentially the same as CmdbCiApplCiscoFibreGet but does not contain the "value", "link" and
...
//
type CmdbCiApplCiscoFibrePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplCiscoFibreGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplCiscoFibre() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplCiscoFibre,
Read:   readResourceCmdbCiApplCiscoFibre,
Update: updateResourceCmdbCiApplCiscoFibre,
Delete: deleteResourceCmdbCiApplCiscoFibre,
...
//
func createResourceCmdbCiApplCiscoFibre(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplCiscoFibrePost
if err := copyFromTerraformToServiceNowCmdbCiApplCiscoFibre(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_cisco_fibre + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplCiscoFibre(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplCiscoFibre(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_cisco_fibre + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplCiscoFibre(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplCiscoFibre(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplCiscoFibre(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplCiscoFibrefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplCiscoFibre (resourceData *schema.ResourceData, ci *CmdbCiApplCiscoFibrePost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.DistinguishedName  = resourceData.Get("distinguished_name").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplCiscoFibre (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplCiscoFibreGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("distinguished_name", attrs.DistinguishedName)
