...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_dot_net CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_dot_net keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_dot_net CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_dot_net  = "cmdb_ci_appl_dot_net"
...
// This is essentially the same as CmdbCiApplDotNetGet but does not contain the "value", "link" and
...
//
type CmdbCiApplDotNetPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplDotNetGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplDotNet() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplDotNet,
Read:   readResourceCmdbCiApplDotNet,
Update: updateResourceCmdbCiApplDotNet,
Delete: deleteResourceCmdbCiApplDotNet,
...
//
func createResourceCmdbCiApplDotNet(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplDotNetPost
if err := copyFromTerraformToServiceNowCmdbCiApplDotNet(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_dot_net + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplDotNet(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplDotNet(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_dot_net + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplDotNet(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplDotNet(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplDotNet(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplDotNetfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplDotNet (resourceData *schema.ResourceData, ci *CmdbCiApplDotNetPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.Executable  = resourceData.Get("executable").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplDotNet (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplDotNetGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("executable", attrs.Executable)
