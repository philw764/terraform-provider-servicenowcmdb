...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_queue CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_queue keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_queue CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_queue  = "cmdb_ci_appl_ora_queue"
...
// This is essentially the same as CmdbCiApplOraQueueGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraQueuePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraQueueGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                Container    string `json:"container,omitempty"`
...
func ResourceCmdbCiApplOraQueue() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraQueue,
Read:   readResourceCmdbCiApplOraQueue,
Update: updateResourceCmdbCiApplOraQueue,
Delete: deleteResourceCmdbCiApplOraQueue,
...
//
func createResourceCmdbCiApplOraQueue(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraQueuePost
if err := copyFromTerraformToServiceNowCmdbCiApplOraQueue(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_queue + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraQueue(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraQueue(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_queue + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraQueue(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraQueue(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraQueue(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraQueuefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraQueue (resourceData *schema.ResourceData, ci *CmdbCiApplOraQueuePost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.Scheme  = resourceData.Get("scheme").(string)
                ...
                attrs.Table  = resourceData.Get("table").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraQueue (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraQueueGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("scheme", attrs.Scheme)
                ...
                _ = resourceData.Set("table", attrs.Table)
