...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_citrix_collector CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_citrix_collector keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_citrix_collector CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_citrix_collector  = "cmdb_ci_appl_citrix_collector"
...
// This is essentially the same as CmdbCiApplCitrixCollectorGet but does not contain the "value", "link" and
...
//
type CmdbCiApplCitrixCollectorPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplCitrixCollectorGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplCitrixCollector() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplCitrixCollector,
Read:   readResourceCmdbCiApplCitrixCollector,
Update: updateResourceCmdbCiApplCitrixCollector,
Delete: deleteResourceCmdbCiApplCitrixCollector,
...
//
func createResourceCmdbCiApplCitrixCollector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplCitrixCollectorPost
if err := copyFromTerraformToServiceNowCmdbCiApplCitrixCollector(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_citrix_collector + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplCitrixCollector(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplCitrixCollector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_citrix_collector + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplCitrixCollector(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplCitrixCollector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplCitrixCollector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplCitrixCollectorfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplCitrixCollector (resourceData *schema.ResourceData, ci *CmdbCiApplCitrixCollectorPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplCitrixCollector (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplCitrixCollectorGet{}
