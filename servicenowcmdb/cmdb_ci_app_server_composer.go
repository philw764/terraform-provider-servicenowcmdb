...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_composer CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_composer keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_composer CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_composer  = "cmdb_ci_app_server_composer"
...
// This is essentially the same as CmdbCiAppServerComposerGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerComposerPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerComposerGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerComposer() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerComposer,
Read:   readResourceCmdbCiAppServerComposer,
Update: updateResourceCmdbCiAppServerComposer,
Delete: deleteResourceCmdbCiAppServerComposer,
...
//
func createResourceCmdbCiAppServerComposer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerComposerPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerComposer(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_composer + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerComposer(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerComposer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_composer + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerComposer(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerComposer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerComposer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerComposerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerComposer (resourceData *schema.ResourceData, ci *CmdbCiAppServerComposerPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.ServerRoot  = resourceData.Get("server_root").(string)
                ...
                attrs.Node  = resourceData.Get("node").(string)
                ...
                attrs.Server  = resourceData.Get("server").(string)
                ...
                attrs.Cell  = resourceData.Get("cell").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerComposer (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerComposerGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("server_root", attrs.ServerRoot)
                ...
                _ = resourceData.Set("node", attrs.Node)
                ...
                _ = resourceData.Set("server", attrs.Server)
                ...
                _ = resourceData.Set("cell", attrs.Cell)
