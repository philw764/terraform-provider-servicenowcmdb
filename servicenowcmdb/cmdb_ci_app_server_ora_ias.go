...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_ora_ias CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_ora_ias keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_ora_ias CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_ora_ias  = "cmdb_ci_app_server_ora_ias"
...
// This is essentially the same as CmdbCiAppServerOraIasGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerOraIasPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerOraIasGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerOraIas() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerOraIas,
Read:   readResourceCmdbCiAppServerOraIas,
Update: updateResourceCmdbCiAppServerOraIas,
Delete: deleteResourceCmdbCiAppServerOraIas,
...
//
func createResourceCmdbCiAppServerOraIas(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerOraIasPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerOraIas(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ora_ias + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerOraIas(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerOraIas(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ora_ias + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerOraIas(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerOraIas(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerOraIas(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerOraIasfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerOraIas (resourceData *schema.ResourceData, ci *CmdbCiAppServerOraIasPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.DatabaseInstance  = resourceData.Get("database_instance").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerOraIas (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerOraIasGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("database_instance", attrs.DatabaseInstance)
