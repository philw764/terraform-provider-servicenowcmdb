...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_generic CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_generic keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_generic CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_generic  = "cmdb_ci_appl_generic"
...
// This is essentially the same as CmdbCiApplGenericGet but does not contain the "value", "link" and
...
//
type CmdbCiApplGenericPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplGenericGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplGeneric() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplGeneric,
Read:   readResourceCmdbCiApplGeneric,
Update: updateResourceCmdbCiApplGeneric,
Delete: deleteResourceCmdbCiApplGeneric,
...
//
func createResourceCmdbCiApplGeneric(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplGenericPost
if err := copyFromTerraformToServiceNowCmdbCiApplGeneric(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_generic + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplGeneric(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplGeneric(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_generic + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplGeneric(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplGeneric(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplGeneric(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplGenericfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplGeneric (resourceData *schema.ResourceData, ci *CmdbCiApplGenericPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplGeneric (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplGenericGet{}
