...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_remedy CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_remedy keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_remedy CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_remedy  = "cmdb_ci_app_server_remedy"
...
// This is essentially the same as CmdbCiAppServerRemedyGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerRemedyPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerRemedyGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerRemedy() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerRemedy,
Read:   readResourceCmdbCiAppServerRemedy,
Update: updateResourceCmdbCiAppServerRemedy,
Delete: deleteResourceCmdbCiAppServerRemedy,
...
//
func createResourceCmdbCiAppServerRemedy(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerRemedyPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerRemedy(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_remedy + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerRemedy(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerRemedy(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_remedy + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerRemedy(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerRemedy(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerRemedy(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerRemedyfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerRemedy (resourceData *schema.ResourceData, ci *CmdbCiAppServerRemedyPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerRemedy (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerRemedyGet{}
