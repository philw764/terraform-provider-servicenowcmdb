...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_tomcat CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_tomcat keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_tomcat CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_tomcat  = "cmdb_ci_app_server_tomcat"
...
// This is essentially the same as CmdbCiAppServerTomcatGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerTomcatPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerTomcatGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerTomcat() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerTomcat,
Read:   readResourceCmdbCiAppServerTomcat,
Update: updateResourceCmdbCiAppServerTomcat,
Delete: deleteResourceCmdbCiAppServerTomcat,
...
//
func createResourceCmdbCiAppServerTomcat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerTomcatPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerTomcat(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_tomcat + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerTomcat(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerTomcat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_tomcat + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerTomcat(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerTomcat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerTomcat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerTomcatfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerTomcat (resourceData *schema.ResourceData, ci *CmdbCiAppServerTomcatPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.ServerPort  = resourceData.Get("server_port").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerTomcat (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerTomcatGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("server_port", attrs.ServerPort)
