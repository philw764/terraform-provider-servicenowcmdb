...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_gg_replicat CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_gg_replicat keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_gg_replicat CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_gg_replicat  = "cmdb_ci_appl_ora_gg_replicat"
...
// This is essentially the same as CmdbCiApplOraGgReplicatGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraGgReplicatPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraGgReplicatGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraGgReplicat() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraGgReplicat,
Read:   readResourceCmdbCiApplOraGgReplicat,
Update: updateResourceCmdbCiApplOraGgReplicat,
Delete: deleteResourceCmdbCiApplOraGgReplicat,
...
//
func createResourceCmdbCiApplOraGgReplicat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraGgReplicatPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraGgReplicat(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_gg_replicat + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraGgReplicat(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraGgReplicat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_gg_replicat + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraGgReplicat(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraGgReplicat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraGgReplicat(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraGgReplicatfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraGgReplicat (resourceData *schema.ResourceData, ci *CmdbCiApplOraGgReplicatPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraGgReplicat (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraGgReplicatGet{}
