...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_domino CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_domino keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_domino CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_domino  = "cmdb_ci_app_server_domino"
...
// This is essentially the same as CmdbCiAppServerDominoGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerDominoPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerDominoGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerDomino() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerDomino,
Read:   readResourceCmdbCiAppServerDomino,
Update: updateResourceCmdbCiAppServerDomino,
Delete: deleteResourceCmdbCiAppServerDomino,
...
//
func createResourceCmdbCiAppServerDomino(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerDominoPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerDomino(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_domino + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerDomino(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerDomino(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_domino + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerDomino(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerDomino(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerDomino(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerDominofailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerDomino (resourceData *schema.ResourceData, ci *CmdbCiAppServerDominoPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerDomino (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerDominoGet{}
