...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_tomcat_war CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_tomcat_war keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_tomcat_war CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_tomcat_war  = "cmdb_ci_app_server_tomcat_war"
...
// This is essentially the same as CmdbCiAppServerTomcatWarGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerTomcatWarPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerTomcatWarGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerTomcatWar() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerTomcatWar,
Read:   readResourceCmdbCiAppServerTomcatWar,
Update: updateResourceCmdbCiAppServerTomcatWar,
Delete: deleteResourceCmdbCiAppServerTomcatWar,
...
//
func createResourceCmdbCiAppServerTomcatWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerTomcatWarPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerTomcatWar(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_tomcat_war + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerTomcatWar(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerTomcatWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_tomcat_war + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerTomcatWar(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerTomcatWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerTomcatWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerTomcatWarfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerTomcatWar (resourceData *schema.ResourceData, ci *CmdbCiAppServerTomcatWarPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerTomcatWar (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerTomcatWarGet{}
