...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_dp_domain CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_dp_domain keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_dp_domain CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_dp_domain  = "cmdb_ci_app_server_dp_domain"
...
// This is essentially the same as CmdbCiAppServerDpDomainGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerDpDomainPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerDpDomainGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerDpDomain() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerDpDomain,
Read:   readResourceCmdbCiAppServerDpDomain,
Update: updateResourceCmdbCiAppServerDpDomain,
Delete: deleteResourceCmdbCiAppServerDpDomain,
...
//
func createResourceCmdbCiAppServerDpDomain(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerDpDomainPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerDpDomain(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_dp_domain + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerDpDomain(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerDpDomain(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_dp_domain + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerDpDomain(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerDpDomain(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerDpDomain(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerDpDomainfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerDpDomain (resourceData *schema.ResourceData, ci *CmdbCiAppServerDpDomainPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerDpDomain (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerDpDomainGet{}
