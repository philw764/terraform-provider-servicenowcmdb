...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ms_dynamic_crm CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ms_dynamic_crm keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ms_dynamic_crm CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ms_dynamic_crm  = "cmdb_ci_appl_ms_dynamic_crm"
...
// This is essentially the same as CmdbCiApplMsDynamicCrmGet but does not contain the "value", "link" and
...
//
type CmdbCiApplMsDynamicCrmPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplMsDynamicCrmGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplMsDynamicCrm() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplMsDynamicCrm,
Read:   readResourceCmdbCiApplMsDynamicCrm,
Update: updateResourceCmdbCiApplMsDynamicCrm,
Delete: deleteResourceCmdbCiApplMsDynamicCrm,
...
//
func createResourceCmdbCiApplMsDynamicCrm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplMsDynamicCrmPost
if err := copyFromTerraformToServiceNowCmdbCiApplMsDynamicCrm(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ms_dynamic_crm + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplMsDynamicCrm(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplMsDynamicCrm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ms_dynamic_crm + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplMsDynamicCrm(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplMsDynamicCrm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplMsDynamicCrm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplMsDynamicCrmfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplMsDynamicCrm (resourceData *schema.ResourceData, ci *CmdbCiApplMsDynamicCrmPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.Role  = resourceData.Get("role").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplMsDynamicCrm (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplMsDynamicCrmGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("role", attrs.Role)
