...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_hp_qc CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_hp_qc keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_hp_qc CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_hp_qc  = "cmdb_ci_appl_hp_qc"
...
// This is essentially the same as CmdbCiApplHpQcGet but does not contain the "value", "link" and
...
//
type CmdbCiApplHpQcPost struct {
Result struct {
Attributes   struct {
...
func ResourceCmdbCiApplHpQc() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplHpQc,
Read:   readResourceCmdbCiApplHpQc,
Update: updateResourceCmdbCiApplHpQc,
Delete: deleteResourceCmdbCiApplHpQc,
...
//
func createResourceCmdbCiApplHpQc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplHpQcPost
if err := copyFromTerraformToServiceNowCmdbCiApplHpQc(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_hp_qc + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplHpQc(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplHpQc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_hp_qc + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplHpQc(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplHpQc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplHpQc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplHpQcfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplHpQc (resourceData *schema.ResourceData, ci *CmdbCiApplHpQcPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplHpQc (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplHpQcGet{}
