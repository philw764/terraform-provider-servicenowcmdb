...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_hp_service CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_hp_service keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_hp_service CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_hp_service  = "cmdb_ci_appl_hp_service"
...
// This is essentially the same as CmdbCiApplHpServiceGet but does not contain the "value", "link" and
...
//
type CmdbCiApplHpServicePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplHpServiceGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplHpService() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplHpService,
Read:   readResourceCmdbCiApplHpService,
Update: updateResourceCmdbCiApplHpService,
Delete: deleteResourceCmdbCiApplHpService,
...
//
func createResourceCmdbCiApplHpService(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplHpServicePost
if err := copyFromTerraformToServiceNowCmdbCiApplHpService(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_hp_service + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplHpService(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplHpService(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_hp_service + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplHpService(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplHpService(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplHpService(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplHpServicefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplHpService (resourceData *schema.ResourceData, ci *CmdbCiApplHpServicePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplHpService (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplHpServiceGet{}
