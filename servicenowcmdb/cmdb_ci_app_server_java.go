...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_java CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_java keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_java CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_java  = "cmdb_ci_app_server_java"
...
// This is essentially the same as CmdbCiAppServerJavaGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerJavaPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerJavaGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerJava() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerJava,
Read:   readResourceCmdbCiAppServerJava,
Update: updateResourceCmdbCiAppServerJava,
Delete: deleteResourceCmdbCiAppServerJava,
...
//
func createResourceCmdbCiAppServerJava(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerJavaPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerJava(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_java + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerJava(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerJava(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_java + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerJava(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerJava(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerJava(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerJavafailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerJava (resourceData *schema.ResourceData, ci *CmdbCiAppServerJavaPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerJava (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerJavaGet{}
