...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_websphere CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_websphere keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_websphere CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_websphere  = "cmdb_ci_app_server_websphere"
...
// This is essentially the same as CmdbCiAppServerWebsphereGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerWebspherePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerWebsphereGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerWebsphere() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerWebsphere,
Read:   readResourceCmdbCiAppServerWebsphere,
Update: updateResourceCmdbCiAppServerWebsphere,
Delete: deleteResourceCmdbCiAppServerWebsphere,
...
//
func createResourceCmdbCiAppServerWebsphere(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerWebspherePost
if err := copyFromTerraformToServiceNowCmdbCiAppServerWebsphere(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_websphere + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerWebsphere(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerWebsphere(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_websphere + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerWebsphere(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerWebsphere(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerWebsphere(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerWebspherefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerWebsphere (resourceData *schema.ResourceData, ci *CmdbCiAppServerWebspherePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerWebsphere (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerWebsphereGet{}
