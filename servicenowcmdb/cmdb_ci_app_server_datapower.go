...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_datapower CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_datapower keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_datapower CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_datapower  = "cmdb_ci_app_server_datapower"
...
// This is essentially the same as CmdbCiAppServerDatapowerGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerDatapowerPost struct {
Result struct {
Attributes   struct {
            ...
            SoapUrl    string `json:"soap_url,omitempty"`
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerDatapowerGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerDatapower() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerDatapower,
Read:   readResourceCmdbCiAppServerDatapower,
Update: updateResourceCmdbCiAppServerDatapower,
Delete: deleteResourceCmdbCiAppServerDatapower,
...
//
func createResourceCmdbCiAppServerDatapower(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerDatapowerPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerDatapower(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_datapower + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerDatapower(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerDatapower(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_datapower + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerDatapower(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerDatapower(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerDatapower(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerDatapowerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerDatapower (resourceData *schema.ResourceData, ci *CmdbCiAppServerDatapowerPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.Domain  = resourceData.Get("domain").(string)
                ...
                attrs.SoapUrl  = resourceData.Get("soap_url").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerDatapower (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerDatapowerGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("domain", attrs.Domain)
                ...
                _ = resourceData.Set("soap_url", attrs.SoapUrl)
