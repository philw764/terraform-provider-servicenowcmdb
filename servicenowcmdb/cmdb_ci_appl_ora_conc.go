...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_conc CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_conc keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_conc CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_conc  = "cmdb_ci_appl_ora_conc"
...
// This is essentially the same as CmdbCiApplOraConcGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraConcPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraConcGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraConc() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraConc,
Read:   readResourceCmdbCiApplOraConc,
Update: updateResourceCmdbCiApplOraConc,
Delete: deleteResourceCmdbCiApplOraConc,
...
//
func createResourceCmdbCiApplOraConc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraConcPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraConc(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_conc + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraConc(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraConc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_conc + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraConc(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraConc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraConc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraConcfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraConc (resourceData *schema.ResourceData, ci *CmdbCiApplOraConcPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraConc (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraConcGet{}
