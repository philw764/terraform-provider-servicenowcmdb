...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_http CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_http keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_http CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_http  = "cmdb_ci_appl_ora_http"
...
// This is essentially the same as CmdbCiApplOraHttpGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraHttpPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraHttpGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraHttp() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraHttp,
Read:   readResourceCmdbCiApplOraHttp,
Update: updateResourceCmdbCiApplOraHttp,
Delete: deleteResourceCmdbCiApplOraHttp,
...
//
func createResourceCmdbCiApplOraHttp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraHttpPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraHttp(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_http + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraHttp(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraHttp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_http + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraHttp(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraHttp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraHttp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraHttpfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraHttp (resourceData *schema.ResourceData, ci *CmdbCiApplOraHttpPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraHttp (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraHttpGet{}
