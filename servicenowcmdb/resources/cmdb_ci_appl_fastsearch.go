...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_fastsearch CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_fastsearch keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_fastsearch CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_fastsearch  = "cmdb_ci_appl_fastsearch"
...
// This is essentially the same as CmdbCiApplFastsearchGet but does not contain the "value", "link" and
...
//
type CmdbCiApplFastsearchPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplFastsearchGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplFastsearch() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplFastsearch,
Read:   readResourceCmdbCiApplFastsearch,
Update: updateResourceCmdbCiApplFastsearch,
Delete: deleteResourceCmdbCiApplFastsearch,
...
//
func createResourceCmdbCiApplFastsearch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplFastsearchPost
if err := copyFromTerraformToServiceNowCmdbCiApplFastsearch(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_fastsearch + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplFastsearch(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplFastsearch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_fastsearch + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplFastsearch(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplFastsearch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplFastsearch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplFastsearchfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplFastsearch (resourceData *schema.ResourceData, ci *CmdbCiApplFastsearchPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.Repository  = resourceData.Get("repository").(string)
                ...
                attrs.IndexName  = resourceData.Get("index_name").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplFastsearch (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplFastsearchGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("repository", attrs.Repository)
                ...
                _ = resourceData.Set("index_name", attrs.IndexName)
