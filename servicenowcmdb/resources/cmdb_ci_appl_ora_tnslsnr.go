...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_tnslsnr CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_tnslsnr keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_tnslsnr CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_tnslsnr  = "cmdb_ci_appl_ora_tnslsnr"
...
// This is essentially the same as CmdbCiApplOraTnslsnrGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraTnslsnrPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraTnslsnrGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraTnslsnr() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraTnslsnr,
Read:   readResourceCmdbCiApplOraTnslsnr,
Update: updateResourceCmdbCiApplOraTnslsnr,
Delete: deleteResourceCmdbCiApplOraTnslsnr,
...
//
func createResourceCmdbCiApplOraTnslsnr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraTnslsnrPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraTnslsnr(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_tnslsnr + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraTnslsnr(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraTnslsnr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_tnslsnr + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraTnslsnr(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraTnslsnr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraTnslsnr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraTnslsnrfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraTnslsnr (resourceData *schema.ResourceData, ci *CmdbCiApplOraTnslsnrPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraTnslsnr (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraTnslsnrGet{}
