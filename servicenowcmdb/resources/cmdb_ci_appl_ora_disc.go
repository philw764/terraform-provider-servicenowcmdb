...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_disc CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_disc keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_disc CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_disc  = "cmdb_ci_appl_ora_disc"
...
// This is essentially the same as CmdbCiApplOraDiscGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraDiscPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraDiscGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraDisc() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraDisc,
Read:   readResourceCmdbCiApplOraDisc,
Update: updateResourceCmdbCiApplOraDisc,
Delete: deleteResourceCmdbCiApplOraDisc,
...
//
func createResourceCmdbCiApplOraDisc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraDiscPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraDisc(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_disc + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraDisc(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraDisc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_disc + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraDisc(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraDisc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraDisc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraDiscfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraDisc (resourceData *schema.ResourceData, ci *CmdbCiApplOraDiscPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraDisc (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraDiscGet{}
