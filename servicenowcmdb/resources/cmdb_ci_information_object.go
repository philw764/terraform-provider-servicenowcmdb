...
//
//  Description       :   This file is the resource provider for the cmdb_ci_information_object CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_information_object keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_information_object CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_information_object  = "cmdb_ci_information_object"
...
// This is essentially the same as CmdbCiInformationObjectGet but does not contain the "value", "link" and
...
//
type CmdbCiInformationObjectPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiInformationObjectGet struct {
Result struct {
Attributes   struct {
                SkipSync    string `json:"skip_sync,omitempty"`
                OperationalStatus    string `json:"operational_status,omitempty"`
...
func ResourceCmdbCiInformationObject() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiInformationObject,
Read:   readResourceCmdbCiInformationObject,
Update: updateResourceCmdbCiInformationObject,
Delete: deleteResourceCmdbCiInformationObject,
...
//
func createResourceCmdbCiInformationObject(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiInformationObjectPost
if err := copyFromTerraformToServiceNowCmdbCiInformationObject(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_information_object + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiInformationObject(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiInformationObject(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_information_object + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiInformationObject(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiInformationObject(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiInformationObject(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiInformationObjectfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiInformationObject (resourceData *schema.ResourceData, ci *CmdbCiInformationObjectPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiInformationObject (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiInformationObjectGet{}
