...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_ora_ias_m CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_ora_ias_m keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_ora_ias_m CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_ora_ias_m  = "cmdb_ci_app_server_ora_ias_m"
...
// This is essentially the same as CmdbCiAppServerOraIasMGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerOraIasMPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerOraIasMGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerOraIasM() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerOraIasM,
Read:   readResourceCmdbCiAppServerOraIasM,
Update: updateResourceCmdbCiAppServerOraIasM,
Delete: deleteResourceCmdbCiAppServerOraIasM,
...
//
func createResourceCmdbCiAppServerOraIasM(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerOraIasMPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerOraIasM(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ora_ias_m + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerOraIasM(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerOraIasM(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ora_ias_m + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerOraIasM(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerOraIasM(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerOraIasM(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerOraIasMfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerOraIasM (resourceData *schema.ResourceData, ci *CmdbCiAppServerOraIasMPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerOraIasM (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerOraIasMGet{}
