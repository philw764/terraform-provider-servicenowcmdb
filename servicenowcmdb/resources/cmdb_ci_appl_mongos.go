...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_mongos CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_mongos keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_mongos CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_mongos  = "cmdb_ci_appl_mongos"
...
// This is essentially the same as CmdbCiApplMongosGet but does not contain the "value", "link" and
...
//
type CmdbCiApplMongosPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplMongosGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplMongos() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplMongos,
Read:   readResourceCmdbCiApplMongos,
Update: updateResourceCmdbCiApplMongos,
Delete: deleteResourceCmdbCiApplMongos,
...
//
func createResourceCmdbCiApplMongos(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplMongosPost
if err := copyFromTerraformToServiceNowCmdbCiApplMongos(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_mongos + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplMongos(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplMongos(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_mongos + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplMongos(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplMongos(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplMongos(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplMongosfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplMongos (resourceData *schema.ResourceData, ci *CmdbCiApplMongosPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplMongos (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplMongosGet{}
