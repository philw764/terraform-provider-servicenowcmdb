...
//
//  Description       :   This file is the resource provider for the cmdb_ci_unix_cluster_node CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_unix_cluster_node keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_unix_cluster_node CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_unix_cluster_node  = "cmdb_ci_unix_cluster_node"
...
// This is essentially the same as CmdbCiUnixClusterNodeGet but does not contain the "value", "link" and
...
//
type CmdbCiUnixClusterNodePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiUnixClusterNodeGet struct {
Result struct {
Attributes   struct {
                Cluster    struct {
...
func ResourceCmdbCiUnixClusterNode() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiUnixClusterNode,
Read:   readResourceCmdbCiUnixClusterNode,
Update: updateResourceCmdbCiUnixClusterNode,
Delete: deleteResourceCmdbCiUnixClusterNode,
...
//
func createResourceCmdbCiUnixClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiUnixClusterNodePost
if err := copyFromTerraformToServiceNowCmdbCiUnixClusterNode(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_unix_cluster_node + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiUnixClusterNode(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiUnixClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_unix_cluster_node + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiUnixClusterNode(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiUnixClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiUnixClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiUnixClusterNodefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiUnixClusterNode (resourceData *schema.ResourceData, ci *CmdbCiUnixClusterNodePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiUnixClusterNode (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiUnixClusterNodeGet{}
