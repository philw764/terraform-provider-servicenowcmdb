...
//
//  Description       :   This file is the resource provider for the cmdb_ci_hardware CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_hardware keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_hardware CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_hardware  = "cmdb_ci_hardware"
...
// This is essentially the same as CmdbCiHardwareGet but does not contain the "value", "link" and
...
//
type CmdbCiHardwarePost struct {
Result struct {
Attributes   struct {
...
func ResourceCmdbCiHardware() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiHardware,
Read:   readResourceCmdbCiHardware,
Update: updateResourceCmdbCiHardware,
Delete: deleteResourceCmdbCiHardware,
...
//
func createResourceCmdbCiHardware(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiHardwarePost
if err := copyFromTerraformToServiceNowCmdbCiHardware(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_hardware + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiHardware(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiHardware(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_hardware + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiHardware(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiHardware(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiHardware(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiHardwarefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiHardware (resourceData *schema.ResourceData, ci *CmdbCiHardwarePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiHardware (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiHardwareGet{}
