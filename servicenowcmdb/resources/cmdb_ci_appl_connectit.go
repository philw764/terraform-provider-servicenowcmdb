...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_connectit CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_connectit keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_connectit CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_connectit  = "cmdb_ci_appl_connectit"
...
// This is essentially the same as CmdbCiApplConnectitGet but does not contain the "value", "link" and
...
//
type CmdbCiApplConnectitPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplConnectitGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplConnectit() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplConnectit,
Read:   readResourceCmdbCiApplConnectit,
Update: updateResourceCmdbCiApplConnectit,
Delete: deleteResourceCmdbCiApplConnectit,
...
//
func createResourceCmdbCiApplConnectit(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplConnectitPost
if err := copyFromTerraformToServiceNowCmdbCiApplConnectit(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_connectit + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplConnectit(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplConnectit(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_connectit + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplConnectit(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplConnectit(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplConnectit(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplConnectitfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplConnectit (resourceData *schema.ResourceData, ci *CmdbCiApplConnectitPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplConnectit (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplConnectitGet{}
