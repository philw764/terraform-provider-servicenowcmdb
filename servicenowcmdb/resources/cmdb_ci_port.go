...
//
//  Description       :   This file is the resource provider for the cmdb_ci_port CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_port keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_port CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_port  = "cmdb_ci_port"
...
// This is essentially the same as CmdbCiPortGet but does not contain the "value", "link" and
...
func ResourceCmdbCiPort() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiPort,
Read:   readResourceCmdbCiPort,
Update: updateResourceCmdbCiPort,
Delete: deleteResourceCmdbCiPort,
...
//
func createResourceCmdbCiPort(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiPortPost
if err := copyFromTerraformToServiceNowCmdbCiPort(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_port + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiPort(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiPort(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_port + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiPort(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiPort(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiPort(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiPortfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiPort (resourceData *schema.ResourceData, ci *CmdbCiPortPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiPort (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiPortGet{}
