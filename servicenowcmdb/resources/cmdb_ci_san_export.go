...
//
//  Description       :   This file is the resource provider for the cmdb_ci_san_export CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_san_export keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_san_export CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_san_export  = "cmdb_ci_san_export"
...
// This is essentially the same as CmdbCiSanExportGet but does not contain the "value", "link" and
...
//
type CmdbCiSanExportPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiSanExportGet struct {
Result struct {
Attributes   struct {
                SkipSync    string `json:"skip_sync,omitempty"`
                OperationalStatus    string `json:"operational_status,omitempty"`
...
func ResourceCmdbCiSanExport() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiSanExport,
Read:   readResourceCmdbCiSanExport,
Update: updateResourceCmdbCiSanExport,
Delete: deleteResourceCmdbCiSanExport,
...
//
func createResourceCmdbCiSanExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiSanExportPost
if err := copyFromTerraformToServiceNowCmdbCiSanExport(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_san_export + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiSanExport(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiSanExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_san_export + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiSanExport(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiSanExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiSanExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiSanExportfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiSanExport (resourceData *schema.ResourceData, ci *CmdbCiSanExportPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiSanExport (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiSanExportGet{}
