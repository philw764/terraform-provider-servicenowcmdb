...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_biztalk_orch CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_biztalk_orch keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_biztalk_orch CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_biztalk_orch  = "cmdb_ci_appl_biztalk_orch"
...
// This is essentially the same as CmdbCiApplBiztalkOrchGet but does not contain the "value", "link" and
...
//
type CmdbCiApplBiztalkOrchPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplBiztalkOrchGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplBiztalkOrch() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplBiztalkOrch,
Read:   readResourceCmdbCiApplBiztalkOrch,
Update: updateResourceCmdbCiApplBiztalkOrch,
Delete: deleteResourceCmdbCiApplBiztalkOrch,
...
//
func createResourceCmdbCiApplBiztalkOrch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplBiztalkOrchPost
if err := copyFromTerraformToServiceNowCmdbCiApplBiztalkOrch(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_biztalk_orch + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplBiztalkOrch(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplBiztalkOrch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_biztalk_orch + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplBiztalkOrch(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplBiztalkOrch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplBiztalkOrch(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplBiztalkOrchfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplBiztalkOrch (resourceData *schema.ResourceData, ci *CmdbCiApplBiztalkOrchPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplBiztalkOrch (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplBiztalkOrchGet{}
