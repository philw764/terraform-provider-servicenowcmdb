...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_itam CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_itam keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_itam CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_itam  = "cmdb_ci_appl_itam"
...
// This is essentially the same as CmdbCiApplItamGet but does not contain the "value", "link" and
...
//
type CmdbCiApplItamPost struct {
Result struct {
Attributes   struct {
...
func ResourceCmdbCiApplItam() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplItam,
Read:   readResourceCmdbCiApplItam,
Update: updateResourceCmdbCiApplItam,
Delete: deleteResourceCmdbCiApplItam,
...
//
func createResourceCmdbCiApplItam(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplItamPost
if err := copyFromTerraformToServiceNowCmdbCiApplItam(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_itam + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplItam(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplItam(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_itam + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplItam(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplItam(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplItam(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplItamfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplItam (resourceData *schema.ResourceData, ci *CmdbCiApplItamPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplItam (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplItamGet{}
