...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_oacore CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_oacore keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_oacore CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_oacore  = "cmdb_ci_appl_ora_oacore"
...
// This is essentially the same as CmdbCiApplOraOacoreGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraOacorePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraOacoreGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraOacore() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraOacore,
Read:   readResourceCmdbCiApplOraOacore,
Update: updateResourceCmdbCiApplOraOacore,
Delete: deleteResourceCmdbCiApplOraOacore,
...
//
func createResourceCmdbCiApplOraOacore(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraOacorePost
if err := copyFromTerraformToServiceNowCmdbCiApplOraOacore(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_oacore + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraOacore(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraOacore(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_oacore + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraOacore(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraOacore(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraOacore(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraOacorefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraOacore (resourceData *schema.ResourceData, ci *CmdbCiApplOraOacorePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraOacore (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraOacoreGet{}
