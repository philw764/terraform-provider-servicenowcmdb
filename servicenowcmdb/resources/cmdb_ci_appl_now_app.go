...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_now_app CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_now_app keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_now_app CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_now_app  = "cmdb_ci_appl_now_app"
...
// This is essentially the same as CmdbCiApplNowAppGet but does not contain the "value", "link" and
...
//
type CmdbCiApplNowAppPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplNowAppGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplNowApp() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplNowApp,
Read:   readResourceCmdbCiApplNowApp,
Update: updateResourceCmdbCiApplNowApp,
Delete: deleteResourceCmdbCiApplNowApp,
...
//
func createResourceCmdbCiApplNowApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplNowAppPost
if err := copyFromTerraformToServiceNowCmdbCiApplNowApp(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_now_app + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplNowApp(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplNowApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_now_app + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplNowApp(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplNowApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplNowApp(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplNowAppfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplNowApp (resourceData *schema.ResourceData, ci *CmdbCiApplNowAppPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplNowApp (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplNowAppGet{}
