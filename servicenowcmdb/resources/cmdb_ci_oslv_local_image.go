...
//
//  Description       :   This file is the resource provider for the cmdb_ci_oslv_local_image CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_oslv_local_image keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_oslv_local_image CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_oslv_local_image  = "cmdb_ci_oslv_local_image"
...
// This is essentially the same as CmdbCiOslvLocalImageGet but does not contain the "value", "link" and
...
//
type CmdbCiOslvLocalImagePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiOslvLocalImageGet struct {
Result struct {
Attributes   struct {
                SkipSync    string `json:"skip_sync,omitempty"`
                OperationalStatus    string `json:"operational_status,omitempty"`
...
func ResourceCmdbCiOslvLocalImage() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiOslvLocalImage,
Read:   readResourceCmdbCiOslvLocalImage,
Update: updateResourceCmdbCiOslvLocalImage,
Delete: deleteResourceCmdbCiOslvLocalImage,
...
//
func createResourceCmdbCiOslvLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiOslvLocalImagePost
if err := copyFromTerraformToServiceNowCmdbCiOslvLocalImage(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_oslv_local_image + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiOslvLocalImage(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiOslvLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_oslv_local_image + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiOslvLocalImage(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiOslvLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiOslvLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiOslvLocalImagefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiOslvLocalImage (resourceData *schema.ResourceData, ci *CmdbCiOslvLocalImagePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiOslvLocalImage (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiOslvLocalImageGet{}
