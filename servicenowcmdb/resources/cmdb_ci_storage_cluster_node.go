...
//
//  Description       :   This file is the resource provider for the cmdb_ci_storage_cluster_node CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_storage_cluster_node keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_storage_cluster_node CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_storage_cluster_node  = "cmdb_ci_storage_cluster_node"
...
// This is essentially the same as CmdbCiStorageClusterNodeGet but does not contain the "value", "link" and
...
//
type CmdbCiStorageClusterNodePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiStorageClusterNodeGet struct {
Result struct {
Attributes   struct {
                Cluster    struct {
...
func ResourceCmdbCiStorageClusterNode() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiStorageClusterNode,
Read:   readResourceCmdbCiStorageClusterNode,
Update: updateResourceCmdbCiStorageClusterNode,
Delete: deleteResourceCmdbCiStorageClusterNode,
...
//
func createResourceCmdbCiStorageClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiStorageClusterNodePost
if err := copyFromTerraformToServiceNowCmdbCiStorageClusterNode(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_storage_cluster_node + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiStorageClusterNode(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiStorageClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_storage_cluster_node + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiStorageClusterNode(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiStorageClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiStorageClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiStorageClusterNodefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiStorageClusterNode (resourceData *schema.ResourceData, ci *CmdbCiStorageClusterNodePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiStorageClusterNode (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiStorageClusterNodeGet{}
