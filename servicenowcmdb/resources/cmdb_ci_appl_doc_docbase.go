...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_doc_docbase CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_doc_docbase keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_doc_docbase CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_doc_docbase  = "cmdb_ci_appl_doc_docbase"
...
// This is essentially the same as CmdbCiApplDocDocbaseGet but does not contain the "value", "link" and
...
//
type CmdbCiApplDocDocbasePost struct {
Result struct {
Attributes   struct {
            ...
            IdNum    string `json:"id,omitempty"`
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplDocDocbaseGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplDocDocbase() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplDocDocbase,
Read:   readResourceCmdbCiApplDocDocbase,
Update: updateResourceCmdbCiApplDocDocbase,
Delete: deleteResourceCmdbCiApplDocDocbase,
...
//
func createResourceCmdbCiApplDocDocbase(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplDocDocbasePost
if err := copyFromTerraformToServiceNowCmdbCiApplDocDocbase(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_doc_docbase + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplDocDocbase(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplDocDocbase(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_doc_docbase + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplDocDocbase(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplDocDocbase(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplDocDocbase(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplDocDocbasefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplDocDocbase (resourceData *schema.ResourceData, ci *CmdbCiApplDocDocbasePost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.IdNum = resourceData.Get("idnum").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplDocDocbase (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplDocDocbaseGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("idnum", attrs.IdNum)
