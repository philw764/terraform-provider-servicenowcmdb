...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_forms_ui CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_forms_ui keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_forms_ui CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_forms_ui  = "cmdb_ci_appl_ora_forms_ui"
...
// This is essentially the same as CmdbCiApplOraFormsUiGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraFormsUiPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraFormsUiGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraFormsUi() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraFormsUi,
Read:   readResourceCmdbCiApplOraFormsUi,
Update: updateResourceCmdbCiApplOraFormsUi,
Delete: deleteResourceCmdbCiApplOraFormsUi,
...
//
func createResourceCmdbCiApplOraFormsUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraFormsUiPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraFormsUi(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_forms_ui + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraFormsUi(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraFormsUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_forms_ui + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraFormsUi(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraFormsUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraFormsUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraFormsUifailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraFormsUi (resourceData *schema.ResourceData, ci *CmdbCiApplOraFormsUiPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraFormsUi (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraFormsUiGet{}
