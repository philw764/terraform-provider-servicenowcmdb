...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_jrun_war CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_jrun_war keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_jrun_war CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_jrun_war  = "cmdb_ci_app_server_jrun_war"
...
// This is essentially the same as CmdbCiAppServerJrunWarGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerJrunWarPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerJrunWarGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerJrunWar() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerJrunWar,
Read:   readResourceCmdbCiAppServerJrunWar,
Update: updateResourceCmdbCiAppServerJrunWar,
Delete: deleteResourceCmdbCiAppServerJrunWar,
...
//
func createResourceCmdbCiAppServerJrunWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerJrunWarPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerJrunWar(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_jrun_war + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerJrunWar(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerJrunWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_jrun_war + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerJrunWar(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerJrunWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerJrunWar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerJrunWarfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerJrunWar (resourceData *schema.ResourceData, ci *CmdbCiAppServerJrunWarPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerJrunWar (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerJrunWarGet{}
