...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_delivery_controler CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_delivery_controler keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_delivery_controler CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_delivery_controler  = "cmdb_ci_appl_delivery_controler"
...
// This is essentially the same as CmdbCiApplDeliveryControlerGet but does not contain the "value", "link" and
...
//
type CmdbCiApplDeliveryControlerPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplDeliveryControlerGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplDeliveryControler() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplDeliveryControler,
Read:   readResourceCmdbCiApplDeliveryControler,
Update: updateResourceCmdbCiApplDeliveryControler,
Delete: deleteResourceCmdbCiApplDeliveryControler,
...
//
func createResourceCmdbCiApplDeliveryControler(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplDeliveryControlerPost
if err := copyFromTerraformToServiceNowCmdbCiApplDeliveryControler(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_delivery_controler + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplDeliveryControler(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplDeliveryControler(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_delivery_controler + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplDeliveryControler(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplDeliveryControler(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplDeliveryControler(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplDeliveryControlerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplDeliveryControler (resourceData *schema.ResourceData, ci *CmdbCiApplDeliveryControlerPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplDeliveryControler (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplDeliveryControlerGet{}
