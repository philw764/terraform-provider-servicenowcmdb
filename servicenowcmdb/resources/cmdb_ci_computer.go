...
//
//  Description       :   This file is the resource provider for the cmdb_ci_computer CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_computer keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_computer CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_computer  = "cmdb_ci_computer"
...
// This is essentially the same as CmdbCiComputerGet but does not contain the "value", "link" and
...
//
type CmdbCiComputerPost struct {
Result struct {
Attributes   struct {
...
func ResourceCmdbCiComputer() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiComputer,
Read:   readResourceCmdbCiComputer,
Update: updateResourceCmdbCiComputer,
Delete: deleteResourceCmdbCiComputer,
...
//
func createResourceCmdbCiComputer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiComputerPost
if err := copyFromTerraformToServiceNowCmdbCiComputer(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_computer + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiComputer(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiComputer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_computer + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiComputer(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiComputer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiComputer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiComputerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiComputer (resourceData *schema.ResourceData, ci *CmdbCiComputerPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiComputer (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiComputerGet{}
