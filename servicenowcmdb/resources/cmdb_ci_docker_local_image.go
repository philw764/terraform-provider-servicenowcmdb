...
//
//  Description       :   This file is the resource provider for the cmdb_ci_docker_local_image CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_docker_local_image keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_docker_local_image CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_docker_local_image  = "cmdb_ci_docker_local_image"
...
// This is essentially the same as CmdbCiDockerLocalImageGet but does not contain the "value", "link" and
...
//
type CmdbCiDockerLocalImagePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiDockerLocalImageGet struct {
Result struct {
Attributes   struct {
                SkipSync    string `json:"skip_sync,omitempty"`
                OperationalStatus    string `json:"operational_status,omitempty"`
...
func ResourceCmdbCiDockerLocalImage() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiDockerLocalImage,
Read:   readResourceCmdbCiDockerLocalImage,
Update: updateResourceCmdbCiDockerLocalImage,
Delete: deleteResourceCmdbCiDockerLocalImage,
...
//
func createResourceCmdbCiDockerLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiDockerLocalImagePost
if err := copyFromTerraformToServiceNowCmdbCiDockerLocalImage(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_docker_local_image + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiDockerLocalImage(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiDockerLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_docker_local_image + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiDockerLocalImage(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiDockerLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiDockerLocalImage(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiDockerLocalImagefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiDockerLocalImage (resourceData *schema.ResourceData, ci *CmdbCiDockerLocalImagePost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.ImageId  = resourceData.Get("image_id").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiDockerLocalImage (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiDockerLocalImageGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("image_id", attrs.ImageId)
