...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_ws_ear CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_ws_ear keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_ws_ear CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_ws_ear  = "cmdb_ci_app_server_ws_ear"
...
// This is essentially the same as CmdbCiAppServerWsEarGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerWsEarPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerWsEarGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerWsEar() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerWsEar,
Read:   readResourceCmdbCiAppServerWsEar,
Update: updateResourceCmdbCiAppServerWsEar,
Delete: deleteResourceCmdbCiAppServerWsEar,
...
//
func createResourceCmdbCiAppServerWsEar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerWsEarPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerWsEar(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ws_ear + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerWsEar(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerWsEar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ws_ear + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerWsEar(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerWsEar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerWsEar(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerWsEarfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerWsEar (resourceData *schema.ResourceData, ci *CmdbCiAppServerWsEarPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerWsEar (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerWsEarGet{}
