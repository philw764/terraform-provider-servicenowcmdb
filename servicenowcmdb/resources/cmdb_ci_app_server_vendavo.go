...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_vendavo CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_vendavo keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_vendavo CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_vendavo  = "cmdb_ci_app_server_vendavo"
...
// This is essentially the same as CmdbCiAppServerVendavoGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerVendavoPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerVendavoGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerVendavo() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerVendavo,
Read:   readResourceCmdbCiAppServerVendavo,
Update: updateResourceCmdbCiAppServerVendavo,
Delete: deleteResourceCmdbCiAppServerVendavo,
...
//
func createResourceCmdbCiAppServerVendavo(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerVendavoPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerVendavo(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_vendavo + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerVendavo(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerVendavo(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_vendavo + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerVendavo(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerVendavo(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerVendavo(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerVendavofailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerVendavo (resourceData *schema.ResourceData, ci *CmdbCiAppServerVendavoPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerVendavo (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerVendavoGet{}
