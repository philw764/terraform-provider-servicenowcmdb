...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server  = "cmdb_ci_app_server"
...
// This is essentially the same as CmdbCiAppServerGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServer() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServer,
Read:   readResourceCmdbCiAppServer,
Update: updateResourceCmdbCiAppServer,
Delete: deleteResourceCmdbCiAppServer,
...
//
func createResourceCmdbCiAppServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerPost
if err := copyFromTerraformToServiceNowCmdbCiAppServer(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServer(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServer(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServer (resourceData *schema.ResourceData, ci *CmdbCiAppServerPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServer (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerGet{}
