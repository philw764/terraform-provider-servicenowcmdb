...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_controlm CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_controlm keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_controlm CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_controlm  = "cmdb_ci_appl_controlm"
...
// This is essentially the same as CmdbCiApplControlmGet but does not contain the "value", "link" and
...
//
type CmdbCiApplControlmPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplControlmGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplControlm() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplControlm,
Read:   readResourceCmdbCiApplControlm,
Update: updateResourceCmdbCiApplControlm,
Delete: deleteResourceCmdbCiApplControlm,
...
//
func createResourceCmdbCiApplControlm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplControlmPost
if err := copyFromTerraformToServiceNowCmdbCiApplControlm(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_controlm + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplControlm(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplControlm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_controlm + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplControlm(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplControlm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplControlm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplControlmfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplControlm (resourceData *schema.ResourceData, ci *CmdbCiApplControlmPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplControlm (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplControlmGet{}
