...
//
//  Description       :   This file is the resource provider for the cmdb_ci_cluster_node CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_cluster_node keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_cluster_node CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_cluster_node  = "cmdb_ci_cluster_node"
...
// This is essentially the same as CmdbCiClusterNodeGet but does not contain the "value", "link" and
...
//
type CmdbCiClusterNodePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiClusterNodeGet struct {
Result struct {
Attributes   struct {
                Cluster    struct {
...
func ResourceCmdbCiClusterNode() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiClusterNode,
Read:   readResourceCmdbCiClusterNode,
Update: updateResourceCmdbCiClusterNode,
Delete: deleteResourceCmdbCiClusterNode,
...
//
func createResourceCmdbCiClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiClusterNodePost
if err := copyFromTerraformToServiceNowCmdbCiClusterNode(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_cluster_node + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiClusterNode(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_cluster_node + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiClusterNode(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiClusterNode(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiClusterNodefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiClusterNode (resourceData *schema.ResourceData, ci *CmdbCiClusterNodePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiClusterNode (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiClusterNodeGet{}
