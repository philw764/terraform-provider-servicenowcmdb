...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ibm_wmb_listener CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ibm_wmb_listener keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ibm_wmb_listener CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ibm_wmb_listener  = "cmdb_ci_appl_ibm_wmb_listener"
...
// This is essentially the same as CmdbCiApplIbmWmbListenerGet but does not contain the "value", "link" and
...
//
type CmdbCiApplIbmWmbListenerPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplIbmWmbListenerGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplIbmWmbListener() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplIbmWmbListener,
Read:   readResourceCmdbCiApplIbmWmbListener,
Update: updateResourceCmdbCiApplIbmWmbListener,
Delete: deleteResourceCmdbCiApplIbmWmbListener,
...
//
func createResourceCmdbCiApplIbmWmbListener(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplIbmWmbListenerPost
if err := copyFromTerraformToServiceNowCmdbCiApplIbmWmbListener(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ibm_wmb_listener + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplIbmWmbListener(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplIbmWmbListener(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ibm_wmb_listener + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplIbmWmbListener(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplIbmWmbListener(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplIbmWmbListener(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplIbmWmbListenerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplIbmWmbListener (resourceData *schema.ResourceData, ci *CmdbCiApplIbmWmbListenerPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.QueueManager  = resourceData.Get("queue_manager").(string)
                ...
                attrs.BrokerName  = resourceData.Get("broker_name").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplIbmWmbListener (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplIbmWmbListenerGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("queue_manager", attrs.QueueManager)
                ...
                _ = resourceData.Set("broker_name", attrs.BrokerName)
