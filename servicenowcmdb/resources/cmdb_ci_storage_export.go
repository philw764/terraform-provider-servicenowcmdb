...
//
//  Description       :   This file is the resource provider for the cmdb_ci_storage_export CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_storage_export keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_storage_export CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_storage_export  = "cmdb_ci_storage_export"
...
// This is essentially the same as CmdbCiStorageExportGet but does not contain the "value", "link" and
...
//
type CmdbCiStorageExportPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiStorageExportGet struct {
Result struct {
Attributes   struct {
                SkipSync    string `json:"skip_sync,omitempty"`
                OperationalStatus    string `json:"operational_status,omitempty"`
...
func ResourceCmdbCiStorageExport() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiStorageExport,
Read:   readResourceCmdbCiStorageExport,
Update: updateResourceCmdbCiStorageExport,
Delete: deleteResourceCmdbCiStorageExport,
...
//
func createResourceCmdbCiStorageExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiStorageExportPost
if err := copyFromTerraformToServiceNowCmdbCiStorageExport(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_storage_export + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiStorageExport(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiStorageExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_storage_export + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiStorageExport(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiStorageExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiStorageExport(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiStorageExportfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiStorageExport (resourceData *schema.ResourceData, ci *CmdbCiStorageExportPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiStorageExport (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiStorageExportGet{}
