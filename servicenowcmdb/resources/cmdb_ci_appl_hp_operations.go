...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_hp_operations CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_hp_operations keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_hp_operations CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_hp_operations  = "cmdb_ci_appl_hp_operations"
...
// This is essentially the same as CmdbCiApplHpOperationsGet but does not contain the "value", "link" and
...
//
type CmdbCiApplHpOperationsPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplHpOperationsGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplHpOperations() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplHpOperations,
Read:   readResourceCmdbCiApplHpOperations,
Update: updateResourceCmdbCiApplHpOperations,
Delete: deleteResourceCmdbCiApplHpOperations,
...
//
func createResourceCmdbCiApplHpOperations(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplHpOperationsPost
if err := copyFromTerraformToServiceNowCmdbCiApplHpOperations(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_hp_operations + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplHpOperations(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplHpOperations(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_hp_operations + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplHpOperations(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplHpOperations(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplHpOperations(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplHpOperationsfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplHpOperations (resourceData *schema.ResourceData, ci *CmdbCiApplHpOperationsPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplHpOperations (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplHpOperationsGet{}
