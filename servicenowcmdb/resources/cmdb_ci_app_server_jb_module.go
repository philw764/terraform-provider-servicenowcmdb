...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_jb_module CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_jb_module keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_jb_module CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_jb_module  = "cmdb_ci_app_server_jb_module"
...
// This is essentially the same as CmdbCiAppServerJbModuleGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerJbModulePost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerJbModuleGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerJbModule() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerJbModule,
Read:   readResourceCmdbCiAppServerJbModule,
Update: updateResourceCmdbCiAppServerJbModule,
Delete: deleteResourceCmdbCiAppServerJbModule,
...
//
func createResourceCmdbCiAppServerJbModule(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerJbModulePost
if err := copyFromTerraformToServiceNowCmdbCiAppServerJbModule(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_jb_module + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerJbModule(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerJbModule(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_jb_module + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerJbModule(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerJbModule(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerJbModule(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerJbModulefailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerJbModule (resourceData *schema.ResourceData, ci *CmdbCiAppServerJbModulePost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerJbModule (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerJbModuleGet{}
