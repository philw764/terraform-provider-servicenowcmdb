...
//
//  Description       :   This file is the resource provider for the cmdb_ci_mfp_printer CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_mfp_printer keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_mfp_printer CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_mfp_printer  = "cmdb_ci_mfp_printer"
...
// This is essentially the same as CmdbCiMfpPrinterGet but does not contain the "value", "link" and
...
//
type CmdbCiMfpPrinterPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiMfpPrinterGet struct {
Result struct {
Attributes   struct {
                SkipSync    string `json:"skip_sync,omitempty"`
                OperationalStatus    string `json:"operational_status,omitempty"`
...
func ResourceCmdbCiMfpPrinter() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiMfpPrinter,
Read:   readResourceCmdbCiMfpPrinter,
Update: updateResourceCmdbCiMfpPrinter,
Delete: deleteResourceCmdbCiMfpPrinter,
...
//
func createResourceCmdbCiMfpPrinter(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiMfpPrinterPost
if err := copyFromTerraformToServiceNowCmdbCiMfpPrinter(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_mfp_printer + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiMfpPrinter(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiMfpPrinter(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_mfp_printer + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiMfpPrinter(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiMfpPrinter(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiMfpPrinter(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiMfpPrinterfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiMfpPrinter (resourceData *schema.ResourceData, ci *CmdbCiMfpPrinterPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiMfpPrinter (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiMfpPrinterGet{}
