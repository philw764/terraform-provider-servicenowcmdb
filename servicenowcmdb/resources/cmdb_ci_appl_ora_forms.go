...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_forms CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_forms keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_forms CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_forms  = "cmdb_ci_appl_ora_forms"
...
// This is essentially the same as CmdbCiApplOraFormsGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraFormsPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraFormsGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraForms() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraForms,
Read:   readResourceCmdbCiApplOraForms,
Update: updateResourceCmdbCiApplOraForms,
Delete: deleteResourceCmdbCiApplOraForms,
...
//
func createResourceCmdbCiApplOraForms(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraFormsPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraForms(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_forms + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraForms(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraForms(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_forms + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraForms(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraForms(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraForms(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraFormsfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraForms (resourceData *schema.ResourceData, ci *CmdbCiApplOraFormsPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraForms (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraFormsGet{}
