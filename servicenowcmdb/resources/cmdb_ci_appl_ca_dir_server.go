...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ca_dir_server CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ca_dir_server keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ca_dir_server CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ca_dir_server  = "cmdb_ci_appl_ca_dir_server"
...
// This is essentially the same as CmdbCiApplCaDirServerGet but does not contain the "value", "link" and
...
//
type CmdbCiApplCaDirServerPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplCaDirServerGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplCaDirServer() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplCaDirServer,
Read:   readResourceCmdbCiApplCaDirServer,
Update: updateResourceCmdbCiApplCaDirServer,
Delete: deleteResourceCmdbCiApplCaDirServer,
...
//
func createResourceCmdbCiApplCaDirServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplCaDirServerPost
if err := copyFromTerraformToServiceNowCmdbCiApplCaDirServer(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ca_dir_server + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplCaDirServer(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplCaDirServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ca_dir_server + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplCaDirServer(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplCaDirServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplCaDirServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplCaDirServerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplCaDirServer (resourceData *schema.ResourceData, ci *CmdbCiApplCaDirServerPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.ProvidedBy  = resourceData.Get("provided_by.value").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplCaDirServer (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplCaDirServerGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("provided_by", StructToMap(attrs.ProvidedBy))
