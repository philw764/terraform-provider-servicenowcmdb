...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ca_ent_man CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ca_ent_man keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ca_ent_man CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ca_ent_man  = "cmdb_ci_appl_ca_ent_man"
...
// This is essentially the same as CmdbCiApplCaEntManGet but does not contain the "value", "link" and
...
//
type CmdbCiApplCaEntManPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplCaEntManGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplCaEntMan() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplCaEntMan,
Read:   readResourceCmdbCiApplCaEntMan,
Update: updateResourceCmdbCiApplCaEntMan,
Delete: deleteResourceCmdbCiApplCaEntMan,
...
//
func createResourceCmdbCiApplCaEntMan(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplCaEntManPost
if err := copyFromTerraformToServiceNowCmdbCiApplCaEntMan(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ca_ent_man + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplCaEntMan(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplCaEntMan(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ca_ent_man + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplCaEntMan(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplCaEntMan(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplCaEntMan(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplCaEntManfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplCaEntMan (resourceData *schema.ResourceData, ci *CmdbCiApplCaEntManPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplCaEntMan (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplCaEntManGet{}
