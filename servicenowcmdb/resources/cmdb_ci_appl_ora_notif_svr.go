...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_notif_svr CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_notif_svr keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_notif_svr CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_notif_svr  = "cmdb_ci_appl_ora_notif_svr"
...
// This is essentially the same as CmdbCiApplOraNotifSvrGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraNotifSvrPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraNotifSvrGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraNotifSvr() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraNotifSvr,
Read:   readResourceCmdbCiApplOraNotifSvr,
Update: updateResourceCmdbCiApplOraNotifSvr,
Delete: deleteResourceCmdbCiApplOraNotifSvr,
...
//
func createResourceCmdbCiApplOraNotifSvr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraNotifSvrPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraNotifSvr(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_notif_svr + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraNotifSvr(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraNotifSvr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_notif_svr + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraNotifSvr(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraNotifSvr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraNotifSvr(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraNotifSvrfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraNotifSvr (resourceData *schema.ResourceData, ci *CmdbCiApplOraNotifSvrPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraNotifSvr (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraNotifSvrGet{}
