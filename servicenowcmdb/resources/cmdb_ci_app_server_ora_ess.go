...
//
//  Description       :   This file is the resource provider for the cmdb_ci_app_server_ora_ess CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_app_server_ora_ess keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_app_server_ora_ess CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_app_server_ora_ess  = "cmdb_ci_app_server_ora_ess"
...
// This is essentially the same as CmdbCiAppServerOraEssGet but does not contain the "value", "link" and
...
//
type CmdbCiAppServerOraEssPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiAppServerOraEssGet struct {
Result struct {
Attributes   struct {
                Container    string `json:"container,omitempty"`
                TcpPort    string `json:"tcp_port,omitempty"`
...
func ResourceCmdbCiAppServerOraEss() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiAppServerOraEss,
Read:   readResourceCmdbCiAppServerOraEss,
Update: updateResourceCmdbCiAppServerOraEss,
Delete: deleteResourceCmdbCiAppServerOraEss,
...
//
func createResourceCmdbCiAppServerOraEss(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiAppServerOraEssPost
if err := copyFromTerraformToServiceNowCmdbCiAppServerOraEss(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ora_ess + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiAppServerOraEss(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiAppServerOraEss(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_app_server_ora_ess + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiAppServerOraEss(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiAppServerOraEss(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiAppServerOraEss(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiAppServerOraEssfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiAppServerOraEss (resourceData *schema.ResourceData, ci *CmdbCiAppServerOraEssPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiAppServerOraEss (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiAppServerOraEssGet{}
