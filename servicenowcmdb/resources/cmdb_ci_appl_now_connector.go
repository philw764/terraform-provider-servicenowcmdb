...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_now_connector CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_now_connector keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_now_connector CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_now_connector  = "cmdb_ci_appl_now_connector"
...
// This is essentially the same as CmdbCiApplNowConnectorGet but does not contain the "value", "link" and
...
//
type CmdbCiApplNowConnectorPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplNowConnectorGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplNowConnector() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplNowConnector,
Read:   readResourceCmdbCiApplNowConnector,
Update: updateResourceCmdbCiApplNowConnector,
Delete: deleteResourceCmdbCiApplNowConnector,
...
//
func createResourceCmdbCiApplNowConnector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplNowConnectorPost
if err := copyFromTerraformToServiceNowCmdbCiApplNowConnector(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_now_connector + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplNowConnector(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplNowConnector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_now_connector + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplNowConnector(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplNowConnector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplNowConnector(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplNowConnectorfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplNowConnector (resourceData *schema.ResourceData, ci *CmdbCiApplNowConnectorPost) error {
...
attrs := &ci.Result.Attributes
                ...
                attrs.InternalName  = resourceData.Get("internal_name").(string)
                ...
                attrs.Connector  = resourceData.Get("connector.value").(string)
...
//
func copyFromServiceNowToTerraformCmdbCiApplNowConnector (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplNowConnectorGet{}
...
attrs := ci.Result.Attributes
                ...
                _ = resourceData.Set("internal_name", attrs.InternalName)
                ...
                _ = resourceData.Set("connector", StructToMap(attrs.Connector))
