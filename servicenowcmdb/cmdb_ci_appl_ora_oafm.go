...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_oafm CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_oafm keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_oafm CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_oafm  = "cmdb_ci_appl_ora_oafm"
...
// This is essentially the same as CmdbCiApplOraOafmGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraOafmPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraOafmGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraOafm() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraOafm,
Read:   readResourceCmdbCiApplOraOafm,
Update: updateResourceCmdbCiApplOraOafm,
Delete: deleteResourceCmdbCiApplOraOafm,
...
//
func createResourceCmdbCiApplOraOafm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraOafmPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraOafm(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_oafm + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraOafm(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraOafm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_oafm + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraOafm(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraOafm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraOafm(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraOafmfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraOafm (resourceData *schema.ResourceData, ci *CmdbCiApplOraOafmPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraOafm (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraOafmGet{}
