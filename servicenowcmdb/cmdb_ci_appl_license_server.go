...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_license_server CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_license_server keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_license_server CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_license_server  = "cmdb_ci_appl_license_server"
...
// This is essentially the same as CmdbCiApplLicenseServerGet but does not contain the "value", "link" and
...
//
type CmdbCiApplLicenseServerPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplLicenseServerGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplLicenseServer() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplLicenseServer,
Read:   readResourceCmdbCiApplLicenseServer,
Update: updateResourceCmdbCiApplLicenseServer,
Delete: deleteResourceCmdbCiApplLicenseServer,
...
//
func createResourceCmdbCiApplLicenseServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplLicenseServerPost
if err := copyFromTerraformToServiceNowCmdbCiApplLicenseServer(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_license_server + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplLicenseServer(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplLicenseServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_license_server + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplLicenseServer(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplLicenseServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplLicenseServer(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplLicenseServerfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplLicenseServer (resourceData *schema.ResourceData, ci *CmdbCiApplLicenseServerPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplLicenseServer (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplLicenseServerGet{}
