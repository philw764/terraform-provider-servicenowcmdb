...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_doc_brava_proc CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_doc_brava_proc keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_doc_brava_proc CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_doc_brava_proc  = "cmdb_ci_appl_doc_brava_proc"
...
// This is essentially the same as CmdbCiApplDocBravaProcGet but does not contain the "value", "link" and
...
//
type CmdbCiApplDocBravaProcPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplDocBravaProcGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplDocBravaProc() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplDocBravaProc,
Read:   readResourceCmdbCiApplDocBravaProc,
Update: updateResourceCmdbCiApplDocBravaProc,
Delete: deleteResourceCmdbCiApplDocBravaProc,
...
//
func createResourceCmdbCiApplDocBravaProc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplDocBravaProcPost
if err := copyFromTerraformToServiceNowCmdbCiApplDocBravaProc(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_doc_brava_proc + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplDocBravaProc(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplDocBravaProc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_doc_brava_proc + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplDocBravaProc(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplDocBravaProc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplDocBravaProc(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplDocBravaProcfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplDocBravaProc (resourceData *schema.ResourceData, ci *CmdbCiApplDocBravaProcPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplDocBravaProc (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplDocBravaProcGet{}
