...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_ebs CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_ebs keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_ebs CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_ebs  = "cmdb_ci_appl_ora_ebs"
...
// This is essentially the same as CmdbCiApplOraEbsGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraEbsPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraEbsGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraEbs() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraEbs,
Read:   readResourceCmdbCiApplOraEbs,
Update: updateResourceCmdbCiApplOraEbs,
Delete: deleteResourceCmdbCiApplOraEbs,
...
//
func createResourceCmdbCiApplOraEbs(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraEbsPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraEbs(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_ebs + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraEbs(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraEbs(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_ebs + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraEbs(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraEbs(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraEbs(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraEbsfailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraEbs (resourceData *schema.ResourceData, ci *CmdbCiApplOraEbsPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraEbs (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraEbsGet{}
