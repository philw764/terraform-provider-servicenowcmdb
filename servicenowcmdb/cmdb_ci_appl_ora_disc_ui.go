...
//
//  Description       :   This file is the resource provider for the cmdb_ci_appl_ora_disc_ui CMDB Class.  This code is executed
//                        when the servicenowcmdb_cmdb_ci_appl_ora_disc_ui keyword is used in a terraform script (*.tf) file
//
//                        This file is will need to be regenerated if the ServiceNow CMDB base CI Class
//                        "cmdb_ci" or of the cmdb_ci_appl_ora_disc_ui CI Class is modified.
///////////////////////////////////////////////////////////////////////////////////////////////////
import (
...
const CiNamecmdb_ci_appl_ora_disc_ui  = "cmdb_ci_appl_ora_disc_ui"
...
// This is essentially the same as CmdbCiApplOraDiscUiGet but does not contain the "value", "link" and
...
//
type CmdbCiApplOraDiscUiPost struct {
Result struct {
Attributes   struct {
...
// The generateprovidersource utility constructs this STRUCT from metadata pulled from ServiceNow.
//
type CmdbCiApplOraDiscUiGet struct {
Result struct {
Attributes   struct {
                TcpPort    string `json:"tcp_port,omitempty"`
                SkipSync    string `json:"skip_sync,omitempty"`
...
func ResourceCmdbCiApplOraDiscUi() *schema.Resource {
return &schema.Resource{
Create: createResourceCmdbCiApplOraDiscUi,
Read:   readResourceCmdbCiApplOraDiscUi,
Update: updateResourceCmdbCiApplOraDiscUi,
Delete: deleteResourceCmdbCiApplOraDiscUi,
...
//
func createResourceCmdbCiApplOraDiscUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client) //Client Connection details
// Use common function to update base attributes
var ci CmdbCiApplOraDiscUiPost
if err := copyFromTerraformToServiceNowCmdbCiApplOraDiscUi(resourceData, &ci); err != nil {
return err
}
...
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_disc_ui + "?sysparm_fields=sys_id"
...
return readResourceCmdbCiApplOraDiscUi(resourceData, serviceNowClient)
}

//  Read routine - This function is called when Terraform wants to create a new CI in the ServiceNow CMDB
//
func readResourceCmdbCiApplOraDiscUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {

servicenowClient := serviceNowClient.(*Client)
SnowUrl := CMDBInstanceApi + CiNamecmdb_ci_appl_ora_disc_ui + "/" + resourceData.Id()
var jsonData []byte
...
if err := copyFromServiceNowToTerraformCmdbCiApplOraDiscUi(resourceData,jsonData);  err != nil {
return err
}
...
//
func updateResourceCmdbCiApplOraDiscUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
servicenowClient := serviceNowClient.(*Client)
...
//
func deleteResourceCmdbCiApplOraDiscUi(resourceData *schema.ResourceData, serviceNowClient interface{}) error {
...
return fmt.Errorf("CmdbCiApplOraDiscUifailed to set install_status field during destroy action %s", err)
}
...
//
func copyFromTerraformToServiceNowCmdbCiApplOraDiscUi (resourceData *schema.ResourceData, ci *CmdbCiApplOraDiscUiPost) error {
...
//
func copyFromServiceNowToTerraformCmdbCiApplOraDiscUi (resourceData *schema.ResourceData, jsonData [] byte) error {
ci := CmdbCiApplOraDiscUiGet{}
